...
class alignas(VL_CACHE_LINE_BYTES) VysyxSoCFull VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    VL_OUT8(&io_icache_state_debug,2,0);
    VL_OUT8(&io_idu_state_debug,1,0);
    VL_OUT8(&io_jump_mispredict_debug,0,0);
    VL_OUT8(&io_exu_state_debug,1,0);
    VL_OUT8(&io_idu_branch_taken_debug,0,0);
    ...
    VL_OUT(&io_wbu_reg_inst_debug,31,0);
    VL_OUT(&io_wbu_reg_pc_debug,31,0);
    VL_OUT(&io_lsu_reg_pc_debug,31,0);
    VL_OUT(&io_wb_data_debug,31,0);
    VL_OUT(&io_idu_rs1_data_debug,31,0);
    VL_OUT(&io_idu_rs2_data_debug,31,0);
    VL_OUT64(&io_perf_jump_mispredict_count,63,0);
    VL_OUT64(&io_icache_miss_count,63,0);
