...
VysyxSoCFull::VysyxSoCFull(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , io_icache_state_debug{vlSymsp->TOP.io_icache_state_debug}
    , io_idu_state_debug{vlSymsp->TOP.io_idu_state_debug}
    , io_jump_mispredict_debug{vlSymsp->TOP.io_jump_mispredict_debug}
    , io_exu_state_debug{vlSymsp->TOP.io_exu_state_debug}
    , io_idu_branch_taken_debug{vlSymsp->TOP.io_idu_branch_taken_debug}
    ...
    , io_wbu_reg_inst_debug{vlSymsp->TOP.io_wbu_reg_inst_debug}
    , io_wbu_reg_pc_debug{vlSymsp->TOP.io_wbu_reg_pc_debug}
    , io_lsu_reg_pc_debug{vlSymsp->TOP.io_lsu_reg_pc_debug}
    , io_wb_data_debug{vlSymsp->TOP.io_wb_data_debug}
    , io_idu_rs1_data_debug{vlSymsp->TOP.io_idu_rs1_data_debug}
    , io_idu_rs2_data_debug{vlSymsp->TOP.io_idu_rs2_data_debug}
    , io_perf_jump_mispredict_count{vlSymsp->TOP.io_perf_jump_mispredict_count}
    , io_icache_miss_count{vlSymsp->TOP.io_icache_miss_count}
