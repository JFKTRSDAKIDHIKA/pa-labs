...
module Xbar(
  ...
  input  [7:0]  io_in_ar_len,
  input  [2:0]  io_in_ar_size,
  input  [1:0]  io_in_ar_burst,
  ...
  output [7:0]  io_soc_ar_len,
  output [2:0]  io_soc_ar_size,
  output [1:0]  io_soc_ar_burst,
  ...
  assign io_in_r_last = ~_GEN & io_soc_r_last;
  ...
  assign io_soc_ar_len = _GEN ? 8'h0 : io_in_ar_len;
  assign io_soc_ar_size = _GEN ? 3'h2 : io_in_ar_size;
  assign io_soc_ar_burst = _GEN ? 2'h1 : io_in_ar_burst;
